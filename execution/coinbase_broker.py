...
class OKXBroker(Broker):
    def __init__(self, config: dict):
        ...
        self.password = os.getenv('COINBASE_PASSPHRASE', '')   # OKX requires a passphrase
    ...
    def connect(self):
        ...
        if self.testnet:
            params['urls'] = {
                'api': 'https://www.coinbase.com/api/v5',
                'test': 'https://www.coinbase.com/api/v5',   # coinbase uses the same URLs for testnet
            }
        ...
        for asset, amount in total.items():
            ...
            if asset == 'USDT':
                ...
                try:
                    ...
                    pass
        return {'net_liquidation': usdt_value, 'account': 'coinbase', 'unrealized_pnl': 0.0}
